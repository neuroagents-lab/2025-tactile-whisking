...
python main.py model=enc_S4_att_mamba model/decoder=empty_ssl \
...
python main.py model=enc_S4_att_mamba model/decoder=linear train.ssl_finetune=True train.ssl=False \
  data.n_times="$n_times" \
  data.input_shape="$input_shape" \
  data.data_dir="$data_dir" \
  train.run_name="$run_name" \
...
# 1000hz, S4+Mamba---opt='sgd'-sch='cos_annealing_w_warmup'-lr=0.1:
# sbatch run_S4_Mamba_ssl_shapenet.sh -L 'SimSiamLoss' -t True -b 512 -n 22 -i '[30, 5, 7]' -r 'tactile1000hz_enc_S4_att_Mamba_simsiam_lbs_rot_tflip110_lr1e_1' -m 'model_configs/rnn_fdb_converted_modern.json' -d '/data/group_data/neuroagents_lab/training_datasets/tactile_whiskers/1000hz/processed' -l 0.1 -o 'sgd' -s 'cos_annealing_w_warmup'

# 1000hz, S4+Mamba---opt='sgd'-sch='cos_annealing_w_warmup'-lr=0.01:
# sbatch run_S4_Mamba_ssl_shapenet.sh -L 'SimSiamLoss' -t True -b 512 -n 22 -i '[30, 5, 7]' -r 'tactile1000hz_enc_S4_att_Mamba_simsiam_lbs_rot_tflip110_lr1e_2' -m 'model_configs/rnn_fdb_converted_modern.json' -d '/data/group_data/neuroagents_lab/training_datasets/tactile_whiskers/1000hz/processed' -l 0.01 -o 'sgd' -s 'cos_annealing_w_warmup'

# 1000hz, S4+Mamba---opt='sgd'-sch='cos_annealing_w_warmup'-lr=0.001:
# sbatch run_S4_Mamba_ssl_shapenet.sh -L 'SimSiamLoss' -t True -b 512 -n 22 -i '[30, 5, 7]' -r 'tactile1000hz_enc_S4_att_Mamba_simsiam_lbs_rot_tflip110_lr1e_3' -m 'model_configs/rnn_fdb_converted_modern.json' -d '/data/group_data/neuroagents_lab/training_datasets/tactile_whiskers/1000hz/processed' -l 0.001 -o 'sgd' -s 'cos_annealing_w_warmup'

# 1000hz, S4+Mamba---opt='sgd'-sch='cos_annealing_w_warmup'-lr=0.0001:
# sbatch run_S4_Mamba_ssl_shapenet.sh -L 'SimSiamLoss' -t True -b 512 -n 22 -i '[30, 5, 7]' -r 'tactile1000hz_enc_S4_att_Mamba_simsiam_lbs_rot_tflip110_lr1e_4' -m 'model_configs/rnn_fdb_converted_modern.json' -d '/data/group_data/neuroagents_lab/training_datasets/tactile_whiskers/1000hz/processed' -l 0.0001 -o 'sgd' -s 'cos_annealing_w_warmup'


## SimCLR w. bs=256 (w. rot+110tflip)
# 1000hz, Zhuang_Mamba---opt='lars'-sch='cos_annealing_w_warmup'-lr=0.1:
# sbatch run_S4_Mamba_ssl_shapenet.sh -L 'SimCLRLoss' -t True -b 256 -n 22 -i '[30, 5, 7]' -r 'tactile1000hz_enc_S4_att_Mamba_simclr_rot_tflip110_lr1e_1' -m 'model_configs/rnn_fdb_converted_modern.json' -d '/data/group_data/neuroagents_lab/training_datasets/tactile_whiskers/1000hz/processed' -l 0.1 -o 'lars' -s 'cos_annealing_w_warmup'

# 1000hz, Zhuang_Mamba---opt='lars'-sch='cos_annealing_w_warmup'-lr=0.01:
# sbatch run_S4_Mamba_ssl_shapenet.sh -L 'SimCLRLoss' -t True -b 256 -n 22 -i '[30, 5, 7]' -r 'tactile1000hz_enc_S4_att_Mamba_simclr_rot_tflip110_lr1e_2' -m 'model_configs/rnn_fdb_converted_modern.json' -d '/data/group_data/neuroagents_lab/training_datasets/tactile_whiskers/1000hz/processed' -l 0.01 -o 'lars' -s 'cos_annealing_w_warmup'

# 1000hz, Zhuang_Mamba---opt='lars'-sch='cos_annealing_w_warmup'-lr=0.001:
# sbatch run_S4_Mamba_ssl_shapenet.sh -L 'SimCLRLoss' -t True -b 256 -n 22 -i '[30, 5, 7]' -r 'tactile1000hz_enc_S4_att_Mamba_simclr_rot_tflip110_lr1e_3' -m 'model_configs/rnn_fdb_converted_modern.json' -d '/data/group_data/neuroagents_lab/training_datasets/tactile_whiskers/1000hz/processed' -l 0.001 -o 'lars' -s 'cos_annealing_w_warmup'

# 1000hz, Zhuang_Mamba---opt='lars'-sch='cos_annealing_w_warmup'-lr=0.0001:
# sbatch run_S4_Mamba_ssl_shapenet.sh -L 'SimCLRLoss' -t True -b 256 -n 22 -i '[30, 5, 7]' -r 'tactile1000hz_enc_S4_att_Mamba_simclr_rot_tflip110_lr1e_4' -m 'model_configs/rnn_fdb_converted_modern.json' -d '/data/group_data/neuroagents_lab/training_datasets/tactile_whiskers/1000hz/processed' -l 0.0001 -o 'lars' -s 'cos_annealing_w_warmup'
