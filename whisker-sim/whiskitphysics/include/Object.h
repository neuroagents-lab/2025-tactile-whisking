...
public:
	...
	std::string filename, btVector4 color, float scaling, float mass, int colGroup, int colMask, bool useConvexHull);
	~Object(){}
	...
	btRigidBody* obj2DynamicBody(std::string fileName,btVector4 color, btVector3 position, btQuaternion orientation, btScalar mass, float scaling_factor, bool useConvexHull,
