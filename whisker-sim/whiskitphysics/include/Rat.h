...
private:
  ...
  // Whisker offset
  //        for rat, was btVector3(0, 13, 1.5);   //unit: mm
  btVector3 originOffset = btVector3(0, 13, 1.5); // unit: mm
  btVector3 originOrientation = btVector3(0, 0, 0);

public:
  Rat(GUIHelperInterface *helper, btDiscreteDynamicsWorld *world,
      btAlignedObjectArray<btCollisionShape *> *shapes, Parameters *parameters, btTransform origin_tf);
  ~Rat() {}
